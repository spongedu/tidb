...
const tableTiKVKeyMetrcisInfo = `CREATE TABLE %s.TIKV_KEY_METRICS_INFO (
  ...
  LEADER_WEIGHT varchar(64) DEFAULT NULL,
  LEADER_SCORE varchar(64) DEFAULT NULL,
  LEADER_SIZE varchar(64) DEFAULT NULL,
  REGION_COUNT varchar(64) DEFAULT NULL,
  REGION_WEIGHT varchar(64) DEFAULT NULL,
  REGION_SCORE varchar(64) DEFAULT NULL,
  REGION_SIZE varchar(64) DEFAULT NULL,
  UPTIME varchar(64) DEFAULT NULL
)`
...
const tableTiKVPerformanceInfo = `CREATE TABLE %s.TIKV_PERFORMANCE_INFO (
  ...
  KV_BATCHGET_COUNT varchar(64) DEFAULT NULL,
